...
class SpectraTimeEvolver:
    ...
    def __time_evolution(self):
        ...
        for i in range(len(self.__t)):
            ...
            comb = SpectraCombiner(self.__standard_wl, self.__T1, self.__T2, self.__R21, self.__rv1[i], self.__rv2[i], self.__v_rot1, self.__v_rot2)
            # copy the combined dataframe in a variable (it's overwritten for a new time_i)
            self.__combined_i = comb.final_df.copy()
