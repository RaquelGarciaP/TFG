...
import Rassine_config as conf

def rassine(input_wave, input_flux):
    ...
    # obtain the config list from Rassine_config.py
    config = conf.config
    ...
    # instead of reading files, we obtain the data as inputs of vectors
    spectrei = input_flux
    grid = input_wave
    ...
    # print('Output file saved under : %s (SNR at 5500 : %.0f)'%(output_dir+'RASSINE_'+new_file+'.p',output['parameters']['SNR_5500']))
