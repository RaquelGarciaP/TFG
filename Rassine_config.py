...
spectrum_name = 'D:/raquel/Desktop/UNI/5e/TFG/GitHub/CombinedSpectra/spectra_time0.csv'  # cwd+'/spectra_library/spectrum_cenB.csv' # full path of your spectrum pickle/csv file
output_dir  = 'D:/raquel/Desktop/UNI/5e/TFG/GitHub/CombinedSpectra/output/'  # cwd+'/output/'                             # directory where output files are written
